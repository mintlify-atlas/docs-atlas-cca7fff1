---
title: "Taller 6: pgvector y búsqueda vectorial con Neon en Colab"
sidebarTitle: "Taller 6 – pgvector"
description: "Habilita pgvector en Neon, genera embeddings con sentence-transformers en Google Colab y ejecuta consultas de similitud vectorial con chunking y SQL."
---
...
<Steps>
  ...
  <Step title="Abrir el notebook de Google Colab">
    Existen dos versiones del notebook para este taller. Ábrela directamente en Google Colab con un clic:

    - **Notebook del profesor (referencia):** [https://colab.research.google.com/drive/1Q2d_XpzW1IlHkZlY6TyxyD7CxyEA6jdw](https://colab.research.google.com/drive/1Q2d_XpzW1IlHkZlY6TyxyD7CxyEA6jdw)
    - **Notebook del estudiante (para trabajar):** [https://colab.research.google.com/drive/1_2LkuJWVDV-IRPP7RCgdegnV_w9osQfI?usp=sharing](https://colab.research.google.com/drive/1_2LkuJWVDV-IRPP7RCgdegnV_w9osQfI?usp=sharing)

    El notebook contiene todas las celdas necesarias para instalar dependencias, conectarse a Neon y ejecutar el pipeline completo. Usa la versión del estudiante para completar el taller; la versión del profesor sirve como referencia de solución.
  </Step>
...
| Versión | Enlace | Uso |
|---------|--------|-----|
| Profesor (solución completa) | [Abrir en Colab](https://colab.research.google.com/drive/1Q2d_XpzW1IlHkZlY6TyxyD7CxyEA6jdw) | Referencia y demostración en clase |
| Estudiante (versión de trabajo) | [Abrir en Colab](https://colab.research.google.com/drive/1_2LkuJWVDV-IRPP7RCgdegnV_w9osQfI?usp=sharing) | Completar durante la sesión del taller |
