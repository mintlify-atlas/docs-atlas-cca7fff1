...
<Steps>
  ...
  <Step title="Ejecuta tu primer script SQL">
    ...
    <CodeGroup>
      ```sql Insertar alumnos de prueba
...
| RelaX | Álgebra relacional | [dbis-uibk.github.io/relax](https://dbis-uibk.github.io/relax/) |
| draw.io | Diagramas EER, Taller 1 | [app.diagrams.net](https://app.diagrams.net/) |
| Google Colab | pgvector, Taller 6 | [colab.research.google.com](https://colab.research.google.com/) |
