...
description: "Práctica DDL en PostgreSQL: crea y altera tablas con restricciones CHECK, UNIQUE y FOREIGN KEY, incluyendo claves compuestas y referencias entre tablas."
---
...
```sql
-- Insertar en table1 primero (no tiene dependencias)
...
-- INSERT INTO table2 (a, c, d) VALUES ('a', 'y', 9);
```
