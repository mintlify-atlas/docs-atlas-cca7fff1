...
<CardGroup cols={2}>
  <Card title="Teoría" icon="book-open">
  ...
  <Card title="Talleres SQL" icon="database">
  ...
  <Card title="Álgebra Relacional" icon="sigma">
  ...
  <Card title="Bases de datos vectoriales" icon="microchip">
...
|--------|---------------|
| Taller 1 | Modelado EER con draw.io |
| Taller 2 | Álgebra relacional con RelaX |
| Taller 3 | DDL/DML inicial en Supabase |
| Taller 4 | Consultas avanzadas y vistas |
| Taller 5 | Bases de datos vectoriales con pgvector |
...
<Note>
  Los ejercicios de álgebra relacional del Taller 2 están disponibles en formato RelaX (`.relaX`) en el repositorio del curso. Cada ejercicio incluye las relaciones de entrada y la solución esperada para que puedas verificar tus respuestas.
</Note>
